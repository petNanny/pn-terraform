...
variable "repo_url" {
  description = "ECR pn backend url repo"
  default     = "312518712322.dkr.ecr.ap-southeast-2.amazonaws.com/pet-nanny-prod"
}

variable "image_tag" {
  description = "pn backend image tag"
  default     = "latest"
}

variable "frontend_bucket_name" {
  description = "pn app s3 bucket name for frontend static webstie"
  default     = "prod-pn-app.petnanny.live"
}